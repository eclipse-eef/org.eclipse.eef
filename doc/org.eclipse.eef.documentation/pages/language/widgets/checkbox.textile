...
* valueExpression: The value expression is used to compute the value to set in the checkbox widget.
* editExpression: The edit expression will be executed when the user will click in the checkbox widget. The current value of the checkbox will be accessible in a variable named @newValue@.
