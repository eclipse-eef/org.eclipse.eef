...
* valueExpression: The value expression is used to compute the value to set in the text field.
* editExpression: The edit expression will be executed when the user will type some content in the text field. The current value of the text field will be accessible in a variable named @newValue@. 
