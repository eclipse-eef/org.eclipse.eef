...
* editExpression: This expression will be executed when the user will select a new value. The selected value will be accessible using the variable @newValue@.
* candidatesExpression: This expression is used to compute all the values to display in the select widget.
* candidateDisplayExpression: This expression is used to cumpte the label of each value in the select widget. Each value will be accessible using the variable @candidate@.
...
* candidatesExpression: @aql:packagename::Class.allInstances()@
