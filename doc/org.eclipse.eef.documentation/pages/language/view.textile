...
* self: An instance of @org.eclipse.emf.ecore.EObject@ which will be the semantic element representing the input
...
p(image). !(view-page-group)view-page-group.png!
