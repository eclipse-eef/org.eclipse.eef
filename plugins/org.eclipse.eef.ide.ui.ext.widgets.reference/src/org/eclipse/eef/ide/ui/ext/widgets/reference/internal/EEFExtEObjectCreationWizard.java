...
public class EEFExtEObjectCreationWizard extends Wizard {
	 ...
	 *            The editing context adapter
	 */
	public EEFExtEObjectCreationWizard(EObject semanticCandidate, EReference eReference, EditingContextAdapter editingContextAdapter) {
	...
	public void addPages() {
		...
		this.eObjectCreationPage = new EEFExtEObjectCreationPage(this.semanticCandidate, this.eReference, this.editingContextAdapter);
