...
public class EEFExtEObjectSelectionWizard extends Wizard {
	 ...
	 *            The editing context adapter
	 */
	public EEFExtEObjectSelectionWizard(EObject semanticCandidate, EReference eReference, EditingContextAdapter editingContextAdapter) {
	...
	public void addPages() {
		...
		this.eObjectSelectionPage = new EEFExtEObjectSelectionPage(this.semanticCandidate, this.eReference, this.editingContextAdapter);
