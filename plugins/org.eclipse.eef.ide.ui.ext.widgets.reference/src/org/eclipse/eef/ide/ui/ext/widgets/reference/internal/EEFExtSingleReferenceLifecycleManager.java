...
public class EEFExtSingleReferenceLifecycleManager extends AbstractEEFExtReferenceLifecycleManager {
	 ...
	 *            The context adapter
	 */
	public EEFExtSingleReferenceLifecycleManager(EEFExtReferenceDescription description, EObject semanticCandidate, EReference eReference,
	...
	protected void browseButtonCallback() {
		IWizard wizard = new EEFExtEObjectSelectionWizard(this.semanticCandidate, this.eReference, this.contextAdapter);
	...
	protected void addButtonCallback() {
		IWizard wizard = new EEFExtEObjectCreationWizard(this.semanticCandidate, eReference, this.contextAdapter);
		WizardDialog wizardDialog = new WizardDialog(this.text.getShell(), wizard);
		wizardDialog.open();
	}
	...
	protected void removeButtonCallback() {
		this.semanticCandidate.eUnset(this.eReference);
	}
