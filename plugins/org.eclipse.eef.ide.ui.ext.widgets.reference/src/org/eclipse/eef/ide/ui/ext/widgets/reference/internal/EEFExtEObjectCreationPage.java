...
public class EEFExtEObjectCreationPage extends WizardPage {
	...
	protected void createReferenceContentPage(Composite parent) {
		if (this.eReference.isContainment()) {
			...
			this.initializeComboViewerInput(this.target, this.eReference);
		} else {
			this.createContainerTreeViewer(parent);
			this.createContainmentFeatureComboViewer(parent);
			this.createEObjectEClassComboViewer(parent);
			this.initializeTreeViewerInput();
		}
	}
	 ...
	 */
	protected void initializeComboViewerInput(EObject eObject, EReference eContainementReference) {
	 ...
	 */
	protected void initializeTreeViewerInput() {
	 ...
	 *            The parent composite
	 */
	protected void createContainerTreeViewer(Composite parent) {
	...
	private void handleEContainmentReferenceSelectionChange() {
		...
		if (eContainer != null) {
			...
			if (eContainmentReference instanceof EReference) {
				this.initializeComboViewerInput(eContainer, (EReference) eContainmentReference);
			}
		}
		this.determinePageCompletion();
	}
