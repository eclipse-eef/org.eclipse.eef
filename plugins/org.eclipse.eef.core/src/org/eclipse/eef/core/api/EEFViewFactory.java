...
public class EEFViewFactory {
	...
	public EEFView createEEFView(EEFViewDescription eefViewDescription, IVariableManager variableManager,
			List<IInterpreterProvider> interpreterProviders) {
		EEFView eefView = new EEFViewImpl(eefViewDescription, variableManager, new EEFCompoundInterpreter(interpreterProviders));
