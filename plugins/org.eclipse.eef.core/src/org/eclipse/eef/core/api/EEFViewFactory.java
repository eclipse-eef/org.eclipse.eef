...
public class EEFViewFactory {
	...
	public EEFView createEEFView(EEFViewDescription eefViewDescription, IVariableManager variableManager, IInterpreter interpreter,
			EditionContextAdapter eca, InputDescriptor input) {
		return this.createEEFView(eefViewDescription, variableManager, interpreter, eca, new EEFDomainClassTester(), input);
	}
	 ...
	 */
	public EEFView createEEFView(EEFViewDescription eefViewDescription, IVariableManager variableManager, IInterpreter interpreter,
			EditionContextAdapter eca, EEFDomainClassTester domainClassTester, InputDescriptor input) {
		EEFView eefView = new EEFViewImpl(eefViewDescription, variableManager, interpreter, eca, domainClassTester);
