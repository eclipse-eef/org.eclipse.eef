...
public class EEFMultipleReferencesController extends AbstractEEFWidgetController implements IEEFMultipleReferencesController {
	...
	/**
	 * The consumer of a new candidates of the list.
	 */
	...
	public void refresh() {
		...
		EAttribute candidatesExpressionEAttribute = EefPackage.Literals.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATES_EXPRESSION;
		...
		this.newEval().call(candidatesExpressionEAttribute, candidatesExpression, new ISuccessfulResultConsumer<Object>() {
			...
			public void apply(Object value) {
				if (value instanceof Iterable<?>) {
					...
					EEFMultipleReferencesController.this.newCandidatesConsumer.apply(candidates);
				}
			}
		});

		String valueExpression = this.description.getValueExpression();
		EAttribute eAttribute = EefPackage.Literals.EEF_MULTIPLE_REFERENCES_DESCRIPTION__VALUE_EXPRESSION;

		this.newEval().call(eAttribute, valueExpression, String.class, new ISuccessfulResultConsumer<String>() {
			@Override
			public void apply(String value) {
				EEFMultipleReferencesController.this.newValueConsumer.apply(value);
			}
		});
	}
	...
	@Override
	public void up(final Object element) {
		final Command command = new RecordingCommand(this.editingDomain) {
			@Override
			protected void doExecute() {
	...
	@Override
	public void down(final Object element) {
		final Command command = new RecordingCommand(this.editingDomain) {
			@Override
			protected void doExecute() {
