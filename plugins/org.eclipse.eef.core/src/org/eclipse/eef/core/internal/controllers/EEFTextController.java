...
public class EEFTextController extends AbstractEEFWidgetController implements IEEFTextController {
	 ...
	 *            The editing context adapter
	 */
	public EEFTextController(EEFTextDescription description, IVariableManager variableManager, IInterpreter interpreter, EditionContextAdapter eca) {
	...
	public void updateValue(final String text) {
		...
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				EEFTextController.this.eca.performModelChange(new Runnable() {
					@Override
					public void run() {
