...
public class EEFViewImpl implements EEFView {
	...
	private EEFPageImpl createPage(EEFPageDescription description) {
		Object candidate = Util.computeCandidate(interpreter, variableManager, description.getSemanticCandidateExpression());
		...
		return new EEFPageImpl(this, description, childVariableManager, interpreter, editingDomain);
	}

	@Override
	public void setInput(EObject eObject) {
		Object selfValue = variableManager.getVariables().get(EEFExpressionUtils.SELF);
