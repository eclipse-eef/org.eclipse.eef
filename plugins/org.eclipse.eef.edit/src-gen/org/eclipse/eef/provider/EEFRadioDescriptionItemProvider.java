...
public class EEFRadioDescriptionItemProvider extends EEFWidgetDescriptionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EefPackage.Literals.EEF_RADIO_DESCRIPTION__STYLE);
			childrenFeatures.add(EefPackage.Literals.EEF_RADIO_DESCRIPTION__CONDITIONAL_STYLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EefPackage.Literals.EEF_RADIO_DESCRIPTION__STYLE, EefFactory.eINSTANCE.createEEFRadioStyle()));

		newChildDescriptors.add(createChildParameter(EefPackage.Literals.EEF_RADIO_DESCRIPTION__CONDITIONAL_STYLES,
				EefFactory.eINSTANCE.createEEFRadioConditionalStyle()));
	}
