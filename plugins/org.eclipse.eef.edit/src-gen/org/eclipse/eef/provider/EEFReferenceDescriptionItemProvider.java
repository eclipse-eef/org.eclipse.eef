...
public class EEFReferenceDescriptionItemProvider extends EEFWidgetDescriptionItemProvider {
	...
	protected void addMultiplePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_EEFReferenceDescription_multiple_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_EEFReferenceDescription_multiple_feature", "_UI_EEFReferenceDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				EefPackage.Literals.EEF_REFERENCE_DESCRIPTION__MULTIPLE, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addValueExpressionPropertyDescriptor(Object object) {
		...
		.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_EEFReferenceDescription_valueExpression_feature"), //$NON-NLS-1$
				getString(
						"_UI_PropertyDescriptor_description", "_UI_EEFReferenceDescription_valueExpression_feature", "_UI_EEFReferenceDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						EefPackage.Literals.EEF_REFERENCE_DESCRIPTION__VALUE_EXPRESSION, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EefPackage.Literals.EEF_REFERENCE_DESCRIPTION__ACTIONS);
			childrenFeatures.add(EefPackage.Literals.EEF_REFERENCE_DESCRIPTION__STYLE);
		}
	...
	/**
	 * This returns EEFReferenceDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EEFReferenceDescription")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((EEFReferenceDescription) object).getIdentifier();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EefPackage.Literals.EEF_REFERENCE_DESCRIPTION__ACTIONS,
				EefFactory.eINSTANCE.createEEFWidgetAction()));

		newChildDescriptors.add(createChildParameter(EefPackage.Literals.EEF_REFERENCE_DESCRIPTION__STYLE,
				EefFactory.eINSTANCE.createEEFReferenceStyle()));
	}
