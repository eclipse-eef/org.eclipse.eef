...
public class EEFMultipleReferencesDescriptionItemProvider extends EEFWidgetDescriptionItemProvider {
	...
	protected void addCandidatesExpressionPropertyDescriptor(Object object) {
		...
		.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_EEFMultipleReferencesDescription_candidatesExpression_feature"), //$NON-NLS-1$
				getString(
						"_UI_PropertyDescriptor_description", "_UI_EEFMultipleReferencesDescription_candidatesExpression_feature", "_UI_EEFMultipleReferencesDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						EefPackage.Literals.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATES_EXPRESSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addCandidateDisplayExpressionPropertyDescriptor(Object object) {
		...
		.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_EEFMultipleReferencesDescription_candidateDisplayExpression_feature"), //$NON-NLS-1$
				getString(
						"_UI_PropertyDescriptor_description", "_UI_EEFMultipleReferencesDescription_candidateDisplayExpression_feature", "_UI_EEFMultipleReferencesDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						EefPackage.Literals.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATE_DISPLAY_EXPRESSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
