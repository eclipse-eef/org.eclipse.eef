...
public class EEFHyperlinkConditionalStyleItemProvider extends EEFConditionalStyleItemProvider {
	 ...
	 * @generated
	 */
	public EEFHyperlinkConditionalStyleItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EefPackage.Literals.EEF_HYPERLINK_CONDITIONAL_STYLE__STYLE);
		}
	...
	/**
	 * This returns EEFHyperlinkConditionalStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EEFHyperlinkConditionalStyle")); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EEFHyperlinkConditionalStyle.class)) {
