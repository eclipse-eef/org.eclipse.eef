...
public class EEFInterpretedTableStructureDescriptionItemProvider extends EEFTableStructureDescriptionItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/EEFInterpretedTableStructureDescription")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_EEFInterpretedTableStructureDescription_type") + " " //$NON-NLS-1$//$NON-NLS-2$
				+ eefInterpretedTableStructureDescription.isMultiple();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(EefPackage.Literals.EEF_INTERPRETED_TABLE_STRUCTURE_DESCRIPTION__COLUMNS,
						EefFactory.eINSTANCE.createEEFColumnDescription()));

		newChildDescriptors
				.add(createChildParameter(EefPackage.Literals.EEF_INTERPRETED_TABLE_STRUCTURE_DESCRIPTION__LINE,
