...
public class EEFHyperlinkStyleItemProvider extends EEFWidgetStyleItemProvider {
	...
	protected void addForegroundColorExpressionPropertyDescriptor(Object object) {
		...
		.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_EEFHyperlinkStyle_foregroundColorExpression_feature"), //$NON-NLS-1$
				getString(
						"_UI_PropertyDescriptor_description", "_UI_EEFHyperlinkStyle_foregroundColorExpression_feature", "_UI_EEFHyperlinkStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						EefPackage.Literals.EEF_HYPERLINK_STYLE__FOREGROUND_COLOR_EXPRESSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
