...
public class EEFCustomExpressionItemProvider extends ItemProviderAdapter
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_EEFCustomExpression_identifier_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_EEFCustomExpression_identifier_feature", "_UI_EEFCustomExpression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				EefPackage.Literals.EEF_CUSTOM_EXPRESSION__IDENTIFIER, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EEFCustomExpression")); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EEFCustomExpression.class)) {
