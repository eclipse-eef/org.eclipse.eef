		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_EEFLinkDescription_onClickExpression_feature", "_UI_EEFLinkDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$
						EefPackage.Literals.EEF_LINK_DESCRIPTION__ON_CLICK_EXPRESSION, true, false, false,
