...
public class EEFTreeDialogSelectDescriptionItemProvider extends EEFCellWidgetDescriptionItemProvider {
	...
	protected void addSemanticCandidateExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_EEFTreeDialogSelectDescription_semanticCandidateExpression_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						"_UI_EEFTreeDialogSelectDescription_semanticCandidateExpression_feature", //$NON-NLS-1$
						"_UI_EEFTreeDialogSelectDescription_type"), //$NON-NLS-1$
				EefPackage.Literals.EEF_TREE_DIALOG_SELECT_DESCRIPTION__SEMANTIC_CANDIDATE_EXPRESSION, true, false,
	...
	protected void addDefaultFilterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_EEFTreeDialogSelectDescription_defaultFilter_feature", //$NON-NLS-1$
								"_UI_EEFTreeDialogSelectDescription_type"), //$NON-NLS-1$
	...
	protected void addDomainClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_EEFTreeDialogSelectDescription_domainClass_feature", //$NON-NLS-1$
								"_UI_EEFTreeDialogSelectDescription_type"), //$NON-NLS-1$
						EefPackage.Literals.EEF_TREE_DIALOG_SELECT_DESCRIPTION__DOMAIN_CLASS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTreePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EEFTreeDialogSelectDescription_tree_feature"), //$NON-NLS-1$
