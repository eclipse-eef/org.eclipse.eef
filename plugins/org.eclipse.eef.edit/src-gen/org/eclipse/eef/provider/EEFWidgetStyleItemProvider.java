...
ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EefPackage.Literals.EEF_WIDGET_STYLE__LABEL_STYLE);
		}
	...
	public String getText(Object object) {
		return getString("_UI_EEFWidgetStyle_type"); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EefPackage.Literals.EEF_WIDGET_STYLE__LABEL_STYLE, EefFactory.eINSTANCE.createEEFTextStyle()));
	}
