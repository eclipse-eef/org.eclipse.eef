 ...
 * @generated
 */
public class EEFTableStructureDescriptionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addMultiplePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_EEFTableStructureDescription_multiple_feature"), //$NON-NLS-1$
				...
				EefPackage.Literals.EEF_TABLE_STRUCTURE_DESCRIPTION__MULTIPLE, true, false, false,
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EEFTableStructureDescription_identifier_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_EEFTableStructureDescription_identifier_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_EEFTableStructureDescription_type"), //$NON-NLS-1$
				EefPackage.Literals.EEF_TABLE_STRUCTURE_DESCRIPTION__IDENTIFIER, true, false, false,
