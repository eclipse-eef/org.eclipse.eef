...
public class EEFImagePickerDescriptionItemProvider extends EEFWidgetDescriptionItemProvider {
	...
	protected void addValueExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_EEFImagePickerDescription_valueExpression_feature"), //$NON-NLS-1$
				...
				EefPackage.Literals.EEF_IMAGE_PICKER_DESCRIPTION__VALUE_EXPRESSION, true, false, false,
	...
	protected void addEditExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EEFImagePickerDescription_editExpression_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_EEFImagePickerDescription_editExpression_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_EEFImagePickerDescription_type"), //$NON-NLS-1$
				EefPackage.Literals.EEF_IMAGE_PICKER_DESCRIPTION__EDIT_EXPRESSION, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_EEFImagePickerDescription_candidatesExpression_feature", //$NON-NLS-1$
								"_UI_EEFImagePickerDescription_type"), //$NON-NLS-1$
