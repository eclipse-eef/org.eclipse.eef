		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_EEFTreeDescription_valueExpression_feature", "_UI_EEFTreeDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$
						EefPackage.Literals.EEF_TREE_DESCRIPTION__VALUE_EXPRESSION, true, false, false,
	...
	protected void addTreeStructurePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_EEFTreeDescription_treeStructure_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_EEFTreeDescription_type"), //$NON-NLS-1$
	...
	protected void addEditExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_EEFTreeDescription_editExpression_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_EEFTreeDescription_type"), //$NON-NLS-1$
						EefPackage.Literals.EEF_TREE_DESCRIPTION__EDIT_EXPRESSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
