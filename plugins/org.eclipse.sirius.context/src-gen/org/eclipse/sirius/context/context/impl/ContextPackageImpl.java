 ...
 */
package org.eclipse.sirius.context.context.impl;
...
import org.eclipse.sirius.context.context.Context;
import org.eclipse.sirius.context.context.ContextFactory;
...
public class ContextPackageImpl extends EPackageImpl implements ContextPackage {
	 ...
	 * @see org.eclipse.sirius.context.context.ContextPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getContextVariable_Documentation() {
		return (EAttribute) contextVariableEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(contextVariableEClass, CONTEXT_VARIABLE__DOCUMENTATION);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(contextVariableEClass, ContextVariable.class, "ContextVariable", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContextVariable_Context(), this.getContext(), null, "context", null, 1, 1, //$NON-NLS-1$
				ContextVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContextVariable_Name(), theEcorePackage.getEString(), "name", null, 0, 1, //$NON-NLS-1$
				ContextVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getContextVariable_Documentation(), theEcorePackage.getEString(), "documentation", null, 0, 1, //$NON-NLS-1$
				ContextVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
