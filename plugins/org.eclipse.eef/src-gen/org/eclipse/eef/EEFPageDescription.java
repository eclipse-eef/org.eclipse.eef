 ...
 *   <li>{@link org.eclipse.eef.EEFPageDescription#getSubPages <em>Sub Pages</em>}</li>
 * </ul>
 *
...
public interface EEFPageDescription extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Sub Pages</b></em>' containment reference list.
	 * The list contents are of type {@link org.eclipse.eef.EEFPageDescription}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * References the Pages which are visible under a Page.
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Sub Pages</em>' containment reference list.
	 * @see org.eclipse.eef.EefPackage#getEEFPageDescription_SubPages()
	 * @model containment="true" resolveProxies="true"
	 * @generated
	 */
	EList<EEFPageDescription> getSubPages();
