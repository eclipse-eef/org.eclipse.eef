...
public interface EEFSpinnerDescription extends EEFWidgetDescription {
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Sets the number of decimal places used by
	 * the receiver. <!-- end-model-doc -->
	 *
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Sets the amount that the receiver's value
	 * will be modified by when the up/down arrows are pressed to the argument, which must be at least one. <!--
	 * end-model-doc -->
	 *
