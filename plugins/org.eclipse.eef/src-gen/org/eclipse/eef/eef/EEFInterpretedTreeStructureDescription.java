 ...
 * <em><b>EEF Interpreted Tree Structure Description</b></em>'. <!--
 * end-user-doc -->
 *
 * <!-- begin-model-doc -->
...
public interface EEFInterpretedTreeStructureDescription extends EEFTreeStructureDescription {
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * Defines how to compute the children. <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Selectable Predicate Expression</b></em>
	 * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
	 * begin-model-doc --> Defines the elements of the Tree that can be
	 * selected. <!-- end-model-doc -->
	 * 
	 * @return the value of the '<em>Selectable Predicate Expression</em>'
	 *         attribute.
