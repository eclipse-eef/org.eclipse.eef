...
public interface EEFContainerDescription extends ContextableElement {
	 ...
	 * identify a specific Container in a Group. <!-- end-model-doc -->
	 * 
	 ...
	 * begin-model-doc --> The elements that are represented. <!-- end-model-doc
	 * -->
	 * 
	 ...
	 * the context in which the Container is used. <!-- end-model-doc -->
	 * 
	 ...
	 * end-user-doc --> <!-- begin-model-doc --> Number of available columns. If
	 * the number of elements is higher than the number of columns then the
	 * elements are represented on the next line. <!-- end-model-doc -->
	 * 
	 ...
	 * {@link org.eclipse.eef.eef.EEFContainerDescription}. <!-- begin-user-doc
	 * --> <!-- end-user-doc --> <!-- begin-model-doc --> Defines
	 * sub-containers. <!-- end-model-doc -->
	 * 
	 ...
	 * {@link org.eclipse.eef.eef.EEFWidgetDescription}. <!-- begin-user-doc -->
	 * <!-- end-user-doc --> <!-- begin-model-doc --> References the widgets to
	 * hold. <!-- end-model-doc -->
	 * 
