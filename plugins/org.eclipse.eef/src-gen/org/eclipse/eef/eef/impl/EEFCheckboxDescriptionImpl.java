 ...
 * <em><b>EEF Checkbox Description</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eef.eef.impl.EEFCheckboxDescriptionImpl#getValueExpression <em>Value Expression</em>}</li>
 *   <li>{@link org.eclipse.eef.eef.impl.EEFCheckboxDescriptionImpl#getEditExpression <em>Edit Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EEFCheckboxDescriptionImpl extends EEFCellWidgetDescriptionImpl implements EEFCheckboxDescription {
	/**
	...
	public void setValueExpression(String newValueExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_CHECKBOX_DESCRIPTION__VALUE_EXPRESSION,
	...
	public void setEditExpression(String newEditExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_CHECKBOX_DESCRIPTION__EDIT_EXPRESSION,
