...
public class EefAdapterFactory extends AdapterFactoryImpl {
	...
	protected EefSwitch<Adapter> modelSwitch = new EefSwitch<Adapter>() {
		...
		@Override
		public Adapter caseEEFCustomDescription(EEFCustomDescription object) {
			return createEEFCustomDescriptionAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.eef.EEFCustomDescription
	 * <em>EEF Custom Description</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 *
	 * @return the new adapter.
