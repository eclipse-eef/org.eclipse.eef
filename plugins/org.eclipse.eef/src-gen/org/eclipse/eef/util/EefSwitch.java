...
public class EefSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EefPackage.EEF_MULTI_TEXT_DESCRIPTION: {
			EEFMultiTextDescription eefMultiTextDescription = (EEFMultiTextDescription) theEObject;
			T result = caseEEFMultiTextDescription(eefMultiTextDescription);
			if (result == null)
				result = caseEEFWidgetDescription(eefMultiTextDescription);
			if (result == null)
				result = caseEEFControlDescription(eefMultiTextDescription);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case EefPackage.EEF_MULTI_TEXT_STYLE: {
			EEFMultiTextStyle eefMultiTextStyle = (EEFMultiTextStyle) theEObject;
			T result = caseEEFMultiTextStyle(eefMultiTextStyle);
			if (result == null)
				result = caseEEFWidgetStyle(eefMultiTextStyle);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case EefPackage.EEF_MULTI_TEXT_CONDITIONAL_STYLE: {
			EEFMultiTextConditionalStyle eefMultiTextConditionalStyle = (EEFMultiTextConditionalStyle) theEObject;
			T result = caseEEFMultiTextConditionalStyle(eefMultiTextConditionalStyle);
			if (result == null)
				result = caseEEFConditionalStyle(eefMultiTextConditionalStyle);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EEF Multi Text Description</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EEF Multi Text Description</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEEFMultiTextDescription(EEFMultiTextDescription object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EEF Multi Text Style</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EEF Multi Text Style</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEEFMultiTextStyle(EEFMultiTextStyle object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EEF Multi Text Conditional Style</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EEF Multi Text Conditional Style</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEEFMultiTextConditionalStyle(EEFMultiTextConditionalStyle object) {
		return null;
	}
