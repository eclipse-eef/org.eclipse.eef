...
public class EefSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EefPackage.EEF_CUSTOM_DESCRIPTION: {
			EEFCustomDescription eefCustomDescription = (EEFCustomDescription) theEObject;
			T result = caseEEFCustomDescription(eefCustomDescription);
			if (result == null) {
				result = caseEEFWidgetDescription(eefCustomDescription);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EEF Custom Description</em>'. <!--
	 * begin-user-doc --> This implementation returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 *
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EEF Custom Description</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEEFCustomDescription(EEFCustomDescription object) {
		return null;
	}
