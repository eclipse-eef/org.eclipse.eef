...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EEF Multi Text Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.eef.impl.EEFMultiTextStyleImpl#getBackgroundColorExpression <em>Background Color Expression</em>}</li>
 *   <li>{@link org.eclipse.eef.impl.EEFMultiTextStyleImpl#getForegroundColorExpression <em>Foreground Color Expression</em>}</li>
 *   <li>{@link org.eclipse.eef.impl.EEFMultiTextStyleImpl#getFontNameExpression <em>Font Name Expression</em>}</li>
 *   <li>{@link org.eclipse.eef.impl.EEFMultiTextStyleImpl#getFontSizeExpression <em>Font Size Expression</em>}</li>
 *   <li>{@link org.eclipse.eef.impl.EEFMultiTextStyleImpl#getFontStyleExpression <em>Font Style Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EEFMultiTextStyleImpl extends EEFWidgetStyleImpl implements EEFMultiTextStyle {
	/**
	 ...
	 * @generated
	 */
	protected EEFMultiTextStyleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EefPackage.Literals.EEF_MULTI_TEXT_STYLE;
	}
	...
	public void setBackgroundColorExpression(String newBackgroundColorExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_MULTI_TEXT_STYLE__BACKGROUND_COLOR_EXPRESSION,
	...
	public void setForegroundColorExpression(String newForegroundColorExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_MULTI_TEXT_STYLE__FOREGROUND_COLOR_EXPRESSION,
	...
	public void setFontNameExpression(String newFontNameExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_MULTI_TEXT_STYLE__FONT_NAME_EXPRESSION, oldFontNameExpression,
					fontNameExpression));
	}
	...
	public void setFontSizeExpression(String newFontSizeExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_MULTI_TEXT_STYLE__FONT_SIZE_EXPRESSION, oldFontSizeExpression,
					fontSizeExpression));
	}
	...
	public void setFontStyleExpression(String newFontStyleExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_MULTI_TEXT_STYLE__FONT_STYLE_EXPRESSION, oldFontStyleExpression,
					fontStyleExpression));
	}
