...
public class EefPackageImpl extends EPackageImpl implements EefPackage {
	...
	public void createPackageContents() {
		...
		eefSpinnerDescriptionEClass = createEClass(EEF_SPINNER_DESCRIPTION);
		createEAttribute(eefSpinnerDescriptionEClass, EEF_SPINNER_DESCRIPTION__VALUE_EXPRESSION);
		createEAttribute(eefSpinnerDescriptionEClass, EEF_SPINNER_DESCRIPTION__EDIT_EXPRESSION);
		createEAttribute(eefSpinnerDescriptionEClass, EEF_SPINNER_DESCRIPTION__DIGITS_EXPRESSION);
		createEAttribute(eefSpinnerDescriptionEClass, EEF_SPINNER_DESCRIPTION__INCREMENT_EXPRESSION);
		createEAttribute(eefSpinnerDescriptionEClass, EEF_SPINNER_DESCRIPTION__MIN_EXPRESSION);
		createEAttribute(eefSpinnerDescriptionEClass, EEF_SPINNER_DESCRIPTION__MAX_EXPRESSION);
		createEReference(eefSpinnerDescriptionEClass, EEF_SPINNER_DESCRIPTION__STYLE);
		createEReference(eefSpinnerDescriptionEClass, EEF_SPINNER_DESCRIPTION__CONDITIONAL_STYLES);
		...
		eefSpinnerStyleEClass = createEClass(EEF_SPINNER_STYLE);
		createEAttribute(eefSpinnerStyleEClass, EEF_SPINNER_STYLE__BACKGROUND_COLOR_EXPRESSION);
		createEAttribute(eefSpinnerStyleEClass, EEF_SPINNER_STYLE__FOREGROUND_COLOR_EXPRESSION);
		createEAttribute(eefSpinnerStyleEClass, EEF_SPINNER_STYLE__FONT_NAME_EXPRESSION);
		createEAttribute(eefSpinnerStyleEClass, EEF_SPINNER_STYLE__FONT_SIZE_EXPRESSION);
		createEAttribute(eefSpinnerStyleEClass, EEF_SPINNER_STYLE__FONT_STYLE_EXPRESSION);
		...
		eefSpinnerConditionalStyleEClass = createEClass(EEF_SPINNER_CONDITIONAL_STYLE);
		createEReference(eefSpinnerConditionalStyleEClass, EEF_SPINNER_CONDITIONAL_STYLE__STYLE);
	...
	public void initializePackageContents() {
		...
		initEClass(eefSpinnerDescriptionEClass, EEFSpinnerDescription.class, "EEFSpinnerDescription", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEEFSpinnerDescription_ValueExpression(), theEcorePackage.getEString(), "valueExpression", null, 0, 1, //$NON-NLS-1$
				EEFSpinnerDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEEFSpinnerDescription_ConditionalStyles(), this.getEEFSpinnerConditionalStyle(), null, "conditionalStyles", null, 0, -1, //$NON-NLS-1$
				EEFSpinnerDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEClass(eefSpinnerStyleEClass, EEFSpinnerStyle.class, "EEFSpinnerStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getEEFSpinnerStyle_BackgroundColorExpression(), ecorePackage.getEString(), "backgroundColorExpression", null, 0, 1, //$NON-NLS-1$
				EEFSpinnerStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(eefSpinnerConditionalStyleEClass, EEFSpinnerConditionalStyle.class, "EEFSpinnerConditionalStyle", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
