...
public class EefPackageImpl extends EPackageImpl implements EefPackage {
	...
	public void createPackageContents() {
		...
		createEReference(eefPageDescriptionEClass, EEF_PAGE_DESCRIPTION__ACTIONS);
		...
		createEReference(eefGroupDescriptionEClass, EEF_GROUP_DESCRIPTION__ACTIONS);

		eefToolbarActionEClass = createEClass(EEF_TOOLBAR_ACTION);
	...
	public void initializePackageContents() {
		...
		initEClass(eefToolbarActionEClass, EEFToolbarAction.class, "EEFToolbarAction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
