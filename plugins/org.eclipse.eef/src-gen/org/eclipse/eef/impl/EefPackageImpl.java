...
public class EefPackageImpl extends EPackageImpl implements EefPackage {
	 ...
	 */
	@Override
	public EAttribute getEEFMultipleReferencesDescription_CandidatesExpression() {
	 ...
	 */
	@Override
	public EAttribute getEEFMultipleReferencesDescription_CandidateDisplayExpression() {
	...
	public EAttribute getEEFMultipleReferencesDescription_DownExpression() {
		return (EAttribute) eefMultipleReferencesDescriptionEClass.getEStructuralFeatures().get(8);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(eefMultipleReferencesDescriptionEClass, EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATES_EXPRESSION);
		createEAttribute(eefMultipleReferencesDescriptionEClass, EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATE_DISPLAY_EXPRESSION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(
				...
				theEcorePackage.getEString(),
				"candidatesExpression", null, 0, 1, EEFMultipleReferencesDescription.class, !EPackageImpl.IS_TRANSIENT, !EPackageImpl.IS_VOLATILE, EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getEEFMultipleReferencesDescription_CandidateDisplayExpression(),
				theEcorePackage.getEString(),
				"candidateDisplayExpression", null, 0, 1, EEFMultipleReferencesDescription.class, !EPackageImpl.IS_TRANSIENT, !EPackageImpl.IS_VOLATILE, EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
