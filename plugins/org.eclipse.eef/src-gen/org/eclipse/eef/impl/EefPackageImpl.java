...
public class EefPackageImpl extends EPackageImpl implements EefPackage {
	 ...
	 * @generated
	 */
	private EClass eefMultiTextDescriptionEClass = null;
	 ...
	 * @generated
	 */
	private EClass eefMultiTextStyleEClass = null;
	 ...
	 * @generated
	 */
	private EClass eefMultiTextConditionalStyleEClass = null;
	 ...
	 */
	@Override
	public EClass getEEFMultiTextDescription() {
		return eefMultiTextDescriptionEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getEEFMultiTextDescription_EditExpression() {
		return (EAttribute) eefMultiTextDescriptionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFMultiTextDescription_AttributeOwnerExpression() {
		return (EAttribute) eefMultiTextDescriptionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFMultiTextDescription_AttributeNameExpression() {
		return (EAttribute) eefMultiTextDescriptionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getEEFMultiTextDescription_Style() {
		return (EReference) eefMultiTextDescriptionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getEEFMultiTextDescription_ConditionalStyles() {
		return (EReference) eefMultiTextDescriptionEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EClass getEEFMultiTextStyle() {
		return eefMultiTextStyleEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getEEFMultiTextStyle_BackgroundColorExpression() {
		return (EAttribute) eefMultiTextStyleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFMultiTextStyle_ForegroundColorExpression() {
		return (EAttribute) eefMultiTextStyleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFMultiTextStyle_FontNameExpression() {
		return (EAttribute) eefMultiTextStyleEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFMultiTextStyle_FontSizeExpression() {
		return (EAttribute) eefMultiTextStyleEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFMultiTextStyle_FontStyleExpression() {
		return (EAttribute) eefMultiTextStyleEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EClass getEEFMultiTextConditionalStyle() {
		return eefMultiTextConditionalStyleEClass;
	}
	 ...
	 */
	@Override
	public EReference getEEFMultiTextConditionalStyle_Style() {
		return (EReference) eefMultiTextConditionalStyleEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		eefMultiTextDescriptionEClass = createEClass(EEF_MULTI_TEXT_DESCRIPTION);
		createEAttribute(eefMultiTextDescriptionEClass, EEF_MULTI_TEXT_DESCRIPTION__EDIT_EXPRESSION);
		createEAttribute(eefMultiTextDescriptionEClass, EEF_MULTI_TEXT_DESCRIPTION__ATTRIBUTE_OWNER_EXPRESSION);
		createEAttribute(eefMultiTextDescriptionEClass, EEF_MULTI_TEXT_DESCRIPTION__ATTRIBUTE_NAME_EXPRESSION);
		createEReference(eefMultiTextDescriptionEClass, EEF_MULTI_TEXT_DESCRIPTION__STYLE);
		createEReference(eefMultiTextDescriptionEClass, EEF_MULTI_TEXT_DESCRIPTION__CONDITIONAL_STYLES);
		...
		eefMultiTextStyleEClass = createEClass(EEF_MULTI_TEXT_STYLE);
		createEAttribute(eefMultiTextStyleEClass, EEF_MULTI_TEXT_STYLE__BACKGROUND_COLOR_EXPRESSION);
		createEAttribute(eefMultiTextStyleEClass, EEF_MULTI_TEXT_STYLE__FOREGROUND_COLOR_EXPRESSION);
		createEAttribute(eefMultiTextStyleEClass, EEF_MULTI_TEXT_STYLE__FONT_NAME_EXPRESSION);
		createEAttribute(eefMultiTextStyleEClass, EEF_MULTI_TEXT_STYLE__FONT_SIZE_EXPRESSION);
		createEAttribute(eefMultiTextStyleEClass, EEF_MULTI_TEXT_STYLE__FONT_STYLE_EXPRESSION);
		...
		eefMultiTextConditionalStyleEClass = createEClass(EEF_MULTI_TEXT_CONDITIONAL_STYLE);
		createEReference(eefMultiTextConditionalStyleEClass, EEF_MULTI_TEXT_CONDITIONAL_STYLE__STYLE);
	...
	public void initializePackageContents() {
		...
		eefMultiTextDescriptionEClass.getESuperTypes().add(this.getEEFWidgetDescription());
		...
		eefMultiTextStyleEClass.getESuperTypes().add(this.getEEFWidgetStyle());
		...
		eefMultiTextConditionalStyleEClass.getESuperTypes().add(this.getEEFConditionalStyle());
		...
		initEAttribute(getEEFGridLayoutDescription_MakeColumnsWithEqualWidth(), theEcorePackage.getEBoolean(), "makeColumnsWithEqualWidth", "false", //$NON-NLS-1$//$NON-NLS-2$
				0, 1, EEFGridLayoutDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEClass(eefMultiTextDescriptionEClass, EEFMultiTextDescription.class, "EEFMultiTextDescription", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEEFMultiTextDescription_EditExpression(), theEcorePackage.getEString(), "editExpression", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEEFMultiTextDescription_AttributeOwnerExpression(), ecorePackage.getEString(), "attributeOwnerExpression", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEEFMultiTextDescription_AttributeNameExpression(), ecorePackage.getEString(), "attributeNameExpression", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getEEFMultiTextDescription_Style(), this.getEEFMultiTextStyle(), null, "style", null, 0, 1, EEFMultiTextDescription.class, //$NON-NLS-1$
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEEFMultiTextDescription_ConditionalStyles(), this.getEEFMultiTextConditionalStyle(), null, "conditionalStyles", null, 0, -1, //$NON-NLS-1$
				EEFMultiTextDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(eefMultiTextStyleEClass, EEFMultiTextStyle.class, "EEFMultiTextStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getEEFMultiTextStyle_BackgroundColorExpression(), ecorePackage.getEString(), "backgroundColorExpression", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEEFMultiTextStyle_ForegroundColorExpression(), ecorePackage.getEString(), "foregroundColorExpression", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEEFMultiTextStyle_FontNameExpression(), ecorePackage.getEString(), "fontNameExpression", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEEFMultiTextStyle_FontSizeExpression(), ecorePackage.getEString(), "fontSizeExpression", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEEFMultiTextStyle_FontStyleExpression(), ecorePackage.getEString(), "fontStyleExpression", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(eefMultiTextConditionalStyleEClass, EEFMultiTextConditionalStyle.class, "EEFMultiTextConditionalStyle", !IS_ABSTRACT, //$NON-NLS-1$
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEEFMultiTextConditionalStyle_Style(), this.getEEFMultiTextStyle(), null, "style", null, 0, 1, //$NON-NLS-1$
				EEFMultiTextConditionalStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
