...
public class EefPackageImpl extends EPackageImpl implements EefPackage {
	 ...
	 */
	@Override
	public EReference getEEFWidgetStyle_LabelStyle() {
		return (EReference) eefWidgetStyleEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(eefWidgetStyleEClass, EefPackage.EEF_WIDGET_STYLE__LABEL_STYLE);
	...
	public void initializePackageContents() {
		...
		initEReference(
				getEEFWidgetStyle_LabelStyle(),
				this.getEEFTextStyle(),
				null,
				"labelStyle", null, 0, 1, EEFWidgetStyle.class, !EPackageImpl.IS_TRANSIENT, !EPackageImpl.IS_VOLATILE, EPackageImpl.IS_CHANGEABLE, EPackageImpl.IS_COMPOSITE, EPackageImpl.IS_RESOLVE_PROXIES, !EPackageImpl.IS_UNSETTABLE, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED); //$NON-NLS-1$
