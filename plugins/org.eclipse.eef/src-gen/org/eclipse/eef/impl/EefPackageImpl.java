...
public class EefPackageImpl extends EPackageImpl implements EefPackage {
	 ...
	 */
	@Override
	public EAttribute getEEFButtonDescription_ButtonImageExpression() {
	...
	public void createPackageContents() {
		...
		createEAttribute(eefButtonDescriptionEClass, EEF_BUTTON_DESCRIPTION__BUTTON_IMAGE_EXPRESSION);
		...
		createEAttribute(eefWidgetActionEClass, EEF_WIDGET_ACTION__IMAGE_EXPRESSION);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEEFButtonDescription_ButtonImageExpression(), ecorePackage.getEString(), "buttonImageExpression", null, 0, 1, //$NON-NLS-1$
				EEFButtonDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
