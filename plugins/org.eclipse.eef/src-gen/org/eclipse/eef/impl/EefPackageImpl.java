...
public class EefPackageImpl extends EPackageImpl implements EefPackage {
	 ...
	 * @generated
	 */
	private EClass eefDateDescriptionEClass = null;
	 ...
	 * @generated
	 */
	private EClass eefDateStyleEClass = null;
	 ...
	 * @generated
	 */
	private EClass eefDateConditionalStyleEClass = null;
	 ...
	 * @generated
	 */
	private EEnum eeF_DATE_DISPLAYEEnum = null;
	 ...
	 */
	@Override
	public EClass getEEFDateDescription() {
		return eefDateDescriptionEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getEEFDateDescription_Display() {
		return (EAttribute) eefDateDescriptionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFDateDescription_ValueExpression() {
		return (EAttribute) eefDateDescriptionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFDateDescription_EditExpression() {
		return (EAttribute) eefDateDescriptionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getEEFDateDescription_Style() {
		return (EReference) eefDateDescriptionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getEEFDateDescription_ConditionalStyles() {
		return (EReference) eefDateDescriptionEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EClass getEEFDateStyle() {
		return eefDateStyleEClass;
	}
	 ...
	 */
	@Override
	public EClass getEEFDateConditionalStyle() {
		return eefDateConditionalStyleEClass;
	}
	 ...
	 */
	@Override
	public EReference getEEFDateConditionalStyle_Style() {
		return (EReference) eefDateConditionalStyleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EEnum getEEF_DATE_DISPLAY() {
		return eeF_DATE_DISPLAYEEnum;
	}
	...
	public void createPackageContents() {
		...
		eefDateDescriptionEClass = createEClass(EEF_DATE_DESCRIPTION);
		createEAttribute(eefDateDescriptionEClass, EEF_DATE_DESCRIPTION__DISPLAY);
		createEAttribute(eefDateDescriptionEClass, EEF_DATE_DESCRIPTION__VALUE_EXPRESSION);
		createEAttribute(eefDateDescriptionEClass, EEF_DATE_DESCRIPTION__EDIT_EXPRESSION);
		createEReference(eefDateDescriptionEClass, EEF_DATE_DESCRIPTION__STYLE);
		createEReference(eefDateDescriptionEClass, EEF_DATE_DESCRIPTION__CONDITIONAL_STYLES);
		...
		eefDateStyleEClass = createEClass(EEF_DATE_STYLE);
		...
		eefDateConditionalStyleEClass = createEClass(EEF_DATE_CONDITIONAL_STYLE);
		createEReference(eefDateConditionalStyleEClass, EEF_DATE_CONDITIONAL_STYLE__STYLE);
		...
		eeF_DATE_DISPLAYEEnum = createEEnum(EEF_DATE_DISPLAY);
	...
	public void initializePackageContents() {
		...
		eefDateDescriptionEClass.getESuperTypes().add(this.getEEFWidgetDescription());
		...
		eefDateStyleEClass.getESuperTypes().add(this.getEEFWidgetStyle());
		...
		eefDateConditionalStyleEClass.getESuperTypes().add(this.getEEFConditionalStyle());
		...
		initEClass(eefDateDescriptionEClass, EEFDateDescription.class, "EEFDateDescription", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEEFDateDescription_Display(), this.getEEF_DATE_DISPLAY(), "display", null, 0, 1, EEFDateDescription.class, !IS_TRANSIENT, //$NON-NLS-1$
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEEFDateDescription_ValueExpression(), theEcorePackage.getEString(), "valueExpression", null, 0, 1, EEFDateDescription.class, //$NON-NLS-1$
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEEFDateDescription_EditExpression(), theEcorePackage.getEString(), "editExpression", null, 0, 1, EEFDateDescription.class, //$NON-NLS-1$
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEEFDateDescription_Style(), this.getEEFDateStyle(), null, "style", null, 0, 1, EEFDateDescription.class, !IS_TRANSIENT, //$NON-NLS-1$
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEEFDateDescription_ConditionalStyles(), this.getEEFDateConditionalStyle(), null, "conditionalStyles", null, 0, -1, //$NON-NLS-1$
				EEFDateDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEClass(eefDateStyleEClass, EEFDateStyle.class, "EEFDateStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		...
		initEClass(eefDateConditionalStyleEClass, EEFDateConditionalStyle.class, "EEFDateConditionalStyle", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEEFDateConditionalStyle_Style(), this.getEEFDateStyle(), null, "style", null, 0, 1, EEFDateConditionalStyle.class, //$NON-NLS-1$
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(eeF_DATE_DISPLAYEEnum, org.eclipse.eef.EEF_DATE_DISPLAY.class, "EEF_DATE_DISPLAY"); //$NON-NLS-1$
		addEEnumLiteral(eeF_DATE_DISPLAYEEnum, org.eclipse.eef.EEF_DATE_DISPLAY.CALENDAR);
		addEEnumLiteral(eeF_DATE_DISPLAYEEnum, org.eclipse.eef.EEF_DATE_DISPLAY.DATE);
		addEEnumLiteral(eeF_DATE_DISPLAYEEnum, org.eclipse.eef.EEF_DATE_DISPLAY.TIME);
