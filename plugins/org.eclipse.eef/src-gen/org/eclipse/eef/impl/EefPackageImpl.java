...
public class EefPackageImpl extends EPackageImpl implements EefPackage {
	 ...
	 * @generated
	 */
	private EClass eefImageViewerDescriptionEClass = null;
	 ...
	 * @generated
	 */
	private EClass eefImageViewerStyleEClass = null;
	 ...
	 * @generated
	 */
	private EClass eefImageViewerConditionalStyleEClass = null;
	 ...
	 */
	@Override
	public EClass getEEFImageViewerDescription() {
		return eefImageViewerDescriptionEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getEEFImageViewerDescription_PathExpression() {
		return (EAttribute) eefImageViewerDescriptionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getEEFImageViewerDescription_EditExpression() {
		return (EAttribute) eefImageViewerDescriptionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EClass getEEFImageViewerStyle() {
		return eefImageViewerStyleEClass;
	}
	 ...
	 */
	@Override
	public EClass getEEFImageViewerConditionalStyle() {
		return eefImageViewerConditionalStyleEClass;
	}
	 ...
	 */
	@Override
	public EReference getEEFImageViewerConditionalStyle_Style() {
		return (EReference) eefImageViewerConditionalStyleEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		eefImageViewerStyleEClass = createEClass(EEF_IMAGE_VIEWER_STYLE);
		...
		eefImageViewerConditionalStyleEClass = createEClass(EEF_IMAGE_VIEWER_CONDITIONAL_STYLE);
		createEReference(eefImageViewerConditionalStyleEClass, EEF_IMAGE_VIEWER_CONDITIONAL_STYLE__STYLE);
	...
	public void initializePackageContents() {
		...
		eefImageViewerDescriptionEClass.getESuperTypes().add(this.getEEFWidgetDescription());
		...
		eefImageViewerStyleEClass.getESuperTypes().add(this.getEEFWidgetStyle());
		...
		eefImageViewerConditionalStyleEClass.getESuperTypes().add(this.getEEFConditionalStyle());
		...
		initEClass(eefImageViewerDescriptionEClass, EEFImageViewerDescription.class, "EEFImageViewerDescription", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEEFImageViewerDescription_PathExpression(), theEcorePackage.getEString(), "pathExpression", null, 0, 1, //$NON-NLS-1$
		...
		initEReference(getEEFImageViewerDescription_Style(), this.getEEFImageViewerStyle(), null, "style", null, 0, 1, //$NON-NLS-1$
				EEFImageViewerDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEEFImageViewerDescription_ConditionalStyles(), this.getEEFImageViewerConditionalStyle(), null, "conditionalStyles", null, 0, //$NON-NLS-1$
				-1, EEFImageViewerDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(eefImageViewerStyleEClass, EEFImageViewerStyle.class, "EEFImageViewerStyle", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(eefImageViewerConditionalStyleEClass, EEFImageViewerConditionalStyle.class, "EEFImageViewerConditionalStyle", !IS_ABSTRACT, //$NON-NLS-1$
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEEFImageViewerConditionalStyle_Style(), this.getEEFImageViewerStyle(), null, "style", null, 0, 1, //$NON-NLS-1$
				EEFImageViewerConditionalStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
