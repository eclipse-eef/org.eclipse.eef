...
public class EEFCheckboxConditionalStyleImpl extends EEFConditionalStyleImpl implements EEFCheckboxConditionalStyle {
	...
	public EEFCheckboxStyle getStyle() {
		if (style != null && style.eIsProxy()) {
			...
			if (style != oldStyle) {
				...
				NotificationChain msgs = oldStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_CHECKBOX_CONDITIONAL_STYLE__STYLE,
						null, null);
				if (newStyle.eInternalContainer() == null) {
					msgs = newStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_CHECKBOX_CONDITIONAL_STYLE__STYLE, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
	...
	public NotificationChain basicSetStyle(EEFCheckboxStyle newStyle, NotificationChain msgs) {
		...
		style = newStyle;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EefPackage.EEF_CHECKBOX_CONDITIONAL_STYLE__STYLE, oldStyle,
					newStyle);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setStyle(EEFCheckboxStyle newStyle) {
		if (newStyle != style) {
			...
			if (style != null)
				msgs = ((InternalEObject) style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_CHECKBOX_CONDITIONAL_STYLE__STYLE, null,
						msgs);
			if (newStyle != null)
				msgs = ((InternalEObject) newStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_CHECKBOX_CONDITIONAL_STYLE__STYLE, null,
						msgs);
