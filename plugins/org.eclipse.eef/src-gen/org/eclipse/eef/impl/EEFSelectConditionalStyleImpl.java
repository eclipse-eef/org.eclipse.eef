...
public class EEFSelectConditionalStyleImpl extends EEFConditionalStyleImpl implements EEFSelectConditionalStyle {
	...
	public EEFSelectStyle getStyle() {
		if (style != null && style.eIsProxy()) {
			...
			if (style != oldStyle) {
				...
				NotificationChain msgs = oldStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_SELECT_CONDITIONAL_STYLE__STYLE, null,
						null);
				if (newStyle.eInternalContainer() == null) {
					msgs = newStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_SELECT_CONDITIONAL_STYLE__STYLE, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
	...
	public void setStyle(EEFSelectStyle newStyle) {
		if (newStyle != style) {
			...
			if (style != null)
				msgs = ((InternalEObject) style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_SELECT_CONDITIONAL_STYLE__STYLE, null,
						msgs);
			if (newStyle != null)
				msgs = ((InternalEObject) newStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_SELECT_CONDITIONAL_STYLE__STYLE, null,
						msgs);
