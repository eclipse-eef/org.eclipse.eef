 ...
 *   <li>{@link org.eclipse.eef.impl.EEFPageDescriptionImpl#getSubPages <em>Sub Pages</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EEFPageDescriptionImpl extends MinimalEObjectImpl.Container implements EEFPageDescription {
	...
	/**
	 * The cached value of the '{@link #getSubPages() <em>Sub Pages</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSubPages()
	 * @generated
	 * @ordered
	 */
	protected EList<EEFPageDescription> subPages;
	 ...
	 */
	@Override
	public EList<EEFPageDescription> getSubPages() {
		if (subPages == null) {
			subPages = new EObjectContainmentEList.Resolving<EEFPageDescription>(EEFPageDescription.class, this,
					EefPackage.EEF_PAGE_DESCRIPTION__SUB_PAGES);
		}
		return subPages;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case EefPackage.EEF_PAGE_DESCRIPTION__SUB_PAGES:
			return ((InternalEList<?>) getSubPages()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case EefPackage.EEF_PAGE_DESCRIPTION__SUB_PAGES:
			getSubPages().clear();
			getSubPages().addAll((Collection<? extends EEFPageDescription>) newValue);
			return;
		}
