 ...
 *   <li>{@link org.eclipse.eef.impl.EEFPageDescriptionImpl#getExtendedPage <em>Extended Page</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EEFPageDescriptionImpl extends MinimalEObjectImpl.Container implements EEFPageDescription {
	...
	public EEFPageDescription getExtendedPage() {
		if (extendedPage != null && extendedPage.eIsProxy()) {
			...
			if (extendedPage != oldExtendedPage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EefPackage.EEF_PAGE_DESCRIPTION__EXTENDED_PAGE, oldExtendedPage,
							extendedPage));
			}
		}
		return extendedPage;
	...
	public void setExtendedPage(EEFPageDescription newExtendedPage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_PAGE_DESCRIPTION__EXTENDED_PAGE, oldExtendedPage, extendedPage));
	}
