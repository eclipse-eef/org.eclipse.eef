 ...
 * </em>}</li>
 * <li>{@link org.eclipse.eef.impl.EEFHyperlinkStyleImpl#getForegroundColorExpression <em>Foreground Color Expression
 * </em>}</li>
...
public class EEFHyperlinkStyleImpl extends EEFWidgetStyleImpl implements EEFHyperlinkStyle {
	 ...
	 * @ordered
	 */
	protected String foregroundColorExpression = EEFHyperlinkStyleImpl.FOREGROUND_COLOR_EXPRESSION_EDEFAULT;
	...
	public void setForegroundColorExpression(String newForegroundColorExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_HYPERLINK_STYLE__FOREGROUND_COLOR_EXPRESSION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EefPackage.EEF_HYPERLINK_STYLE__FOREGROUND_COLOR_EXPRESSION:
	...
	public void eUnset(int featureID) {
		...
		case EefPackage.EEF_HYPERLINK_STYLE__BACKGROUND_COLOR_EXPRESSION:
			...
			return;
		case EefPackage.EEF_HYPERLINK_STYLE__FOREGROUND_COLOR_EXPRESSION:
			setForegroundColorExpression(EEFHyperlinkStyleImpl.FOREGROUND_COLOR_EXPRESSION_EDEFAULT);
			return;
		case EefPackage.EEF_HYPERLINK_STYLE__FONT_NAME_EXPRESSION:
	...
	public boolean eIsSet(int featureID) {
		...
		case EefPackage.EEF_HYPERLINK_STYLE__FOREGROUND_COLOR_EXPRESSION:
			return EEFHyperlinkStyleImpl.FOREGROUND_COLOR_EXPRESSION_EDEFAULT == null ? foregroundColorExpression != null
			: !EEFHyperlinkStyleImpl.FOREGROUND_COLOR_EXPRESSION_EDEFAULT.equals(foregroundColorExpression);
		case EefPackage.EEF_HYPERLINK_STYLE__FONT_NAME_EXPRESSION:
