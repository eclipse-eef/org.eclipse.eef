...
public class EEFSpinnerDescriptionImpl extends EEFWidgetDescriptionImpl implements EEFSpinnerDescription {
	 ...
	 * @ordered
	 */
	protected static final String DIGITS_EXPRESSION_EDEFAULT = "0";
	 ...
	 * @ordered
	 */
	protected String digitsExpression = DIGITS_EXPRESSION_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final String INCREMENT_EXPRESSION_EDEFAULT = "1";
	 ...
	 * @ordered
	 */
	protected String incrementExpression = INCREMENT_EXPRESSION_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected String minExpression = MIN_EXPRESSION_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected String maxExpression = MAX_EXPRESSION_EDEFAULT;
	...
	public EEFSpinnerStyle getStyle() {
		if (style != null && style.eIsProxy()) {
			...
			if (style != oldStyle) {
				...
				NotificationChain msgs = oldStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_SPINNER_DESCRIPTION__STYLE, null,
						null);
				if (newStyle.eInternalContainer() == null) {
					msgs = newStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_SPINNER_DESCRIPTION__STYLE, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
	...
	public void setStyle(EEFSpinnerStyle newStyle) {
		if (newStyle != style) {
			...
			if (style != null)
				msgs = ((InternalEObject) style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_SPINNER_DESCRIPTION__STYLE, null, msgs);
			if (newStyle != null)
				msgs = ((InternalEObject) newStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EefPackage.EEF_SPINNER_DESCRIPTION__STYLE, null, msgs);
	...
	public EList<EEFSpinnerConditionalStyle> getConditionalStyles() {
		if (conditionalStyles == null) {
			conditionalStyles = new EObjectContainmentEList.Resolving<EEFSpinnerConditionalStyle>(EEFSpinnerConditionalStyle.class, this,
	...
	public void eUnset(int featureID) {
		...
		case EefPackage.EEF_SPINNER_DESCRIPTION__EDIT_EXPRESSION:
			...
			return;
		case EefPackage.EEF_SPINNER_DESCRIPTION__DIGITS_EXPRESSION:
			setDigitsExpression(DIGITS_EXPRESSION_EDEFAULT);
			return;
		case EefPackage.EEF_SPINNER_DESCRIPTION__INCREMENT_EXPRESSION:
			setIncrementExpression(INCREMENT_EXPRESSION_EDEFAULT);
			return;
		case EefPackage.EEF_SPINNER_DESCRIPTION__MIN_EXPRESSION:
			setMinExpression(MIN_EXPRESSION_EDEFAULT);
			return;
		case EefPackage.EEF_SPINNER_DESCRIPTION__MAX_EXPRESSION:
			setMaxExpression(MAX_EXPRESSION_EDEFAULT);
			return;
		case EefPackage.EEF_SPINNER_DESCRIPTION__STYLE:
	...
	public boolean eIsSet(int featureID) {
		...
		case EefPackage.EEF_SPINNER_DESCRIPTION__DIGITS_EXPRESSION:
			return DIGITS_EXPRESSION_EDEFAULT == null ? digitsExpression != null : !DIGITS_EXPRESSION_EDEFAULT.equals(digitsExpression);
		case EefPackage.EEF_SPINNER_DESCRIPTION__INCREMENT_EXPRESSION:
			return INCREMENT_EXPRESSION_EDEFAULT == null ? incrementExpression != null : !INCREMENT_EXPRESSION_EDEFAULT.equals(incrementExpression);
		case EefPackage.EEF_SPINNER_DESCRIPTION__MIN_EXPRESSION:
			return MIN_EXPRESSION_EDEFAULT == null ? minExpression != null : !MIN_EXPRESSION_EDEFAULT.equals(minExpression);
		case EefPackage.EEF_SPINNER_DESCRIPTION__MAX_EXPRESSION:
			return MAX_EXPRESSION_EDEFAULT == null ? maxExpression != null : !MAX_EXPRESSION_EDEFAULT.equals(maxExpression);
		case EefPackage.EEF_SPINNER_DESCRIPTION__STYLE:
			return style != null;
		case EefPackage.EEF_SPINNER_DESCRIPTION__CONDITIONAL_STYLES:
