...
public class EefFactoryImpl extends EFactoryImpl implements EefFactory {
	...
	public EObject create(EClass eClass) {
		...
		case EefPackage.EEF_FILE_PICKER_DESCRIPTION:
			return createEEFFilePickerDescription();
		...
		case EefPackage.EEF_FILE_PICKER_STYLE:
			return createEEFFilePickerStyle();
		...
		case EefPackage.EEF_FILE_PICKER_CONDITIONAL_STYLE:
			return createEEFFilePickerConditionalStyle();
	 ...
	 */
	@Override
	public EEFFilePickerDescription createEEFFilePickerDescription() {
		EEFFilePickerDescriptionImpl eefFilePickerDescription = new EEFFilePickerDescriptionImpl();
	 ...
	 */
	@Override
	public EEFFilePickerStyle createEEFFilePickerStyle() {
		EEFFilePickerStyleImpl eefFilePickerStyle = new EEFFilePickerStyleImpl();
		return eefFilePickerStyle;
	}
	 ...
	 */
	@Override
	public EEFFilePickerConditionalStyle createEEFFilePickerConditionalStyle() {
		EEFFilePickerConditionalStyleImpl eefFilePickerConditionalStyle = new EEFFilePickerConditionalStyleImpl();
		return eefFilePickerConditionalStyle;
	}
