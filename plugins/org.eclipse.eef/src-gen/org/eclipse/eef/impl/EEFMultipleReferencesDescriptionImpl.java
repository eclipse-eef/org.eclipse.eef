 ...
 * <li>{@link org.eclipse.eef.impl.EEFMultipleReferencesDescriptionImpl#getCandidatesExpression <em>Candidates
 * Expression</em>}</li>
 * <li>{@link org.eclipse.eef.impl.EEFMultipleReferencesDescriptionImpl#getCandidateDisplayExpression <em>Candidate
...
public class EEFMultipleReferencesDescriptionImpl extends EEFWidgetDescriptionImpl implements EEFMultipleReferencesDescription {
	 ...
	 * @ordered
	 */
	protected String candidatesExpression = EEFMultipleReferencesDescriptionImpl.CANDIDATES_EXPRESSION_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected String candidateDisplayExpression = EEFMultipleReferencesDescriptionImpl.CANDIDATE_DISPLAY_EXPRESSION_EDEFAULT;
	...
	public void setCandidatesExpression(String newCandidatesExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATES_EXPRESSION,
	...
	public void setCandidateDisplayExpression(String newCandidateDisplayExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATE_DISPLAY_EXPRESSION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATES_EXPRESSION:
			return getCandidatesExpression();
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATE_DISPLAY_EXPRESSION:
	...
	public void eUnset(int featureID) {
		...
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__VALUE_EXPRESSION:
			...
			return;
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATES_EXPRESSION:
			setCandidatesExpression(EEFMultipleReferencesDescriptionImpl.CANDIDATES_EXPRESSION_EDEFAULT);
			return;
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATE_DISPLAY_EXPRESSION:
			setCandidateDisplayExpression(EEFMultipleReferencesDescriptionImpl.CANDIDATE_DISPLAY_EXPRESSION_EDEFAULT);
			return;
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__ON_CLICK_EXPRESSION:
	...
	public boolean eIsSet(int featureID) {
		...
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATES_EXPRESSION:
			return EEFMultipleReferencesDescriptionImpl.CANDIDATES_EXPRESSION_EDEFAULT == null ? candidatesExpression != null
			: !EEFMultipleReferencesDescriptionImpl.CANDIDATES_EXPRESSION_EDEFAULT.equals(candidatesExpression);
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__CANDIDATE_DISPLAY_EXPRESSION:
			return EEFMultipleReferencesDescriptionImpl.CANDIDATE_DISPLAY_EXPRESSION_EDEFAULT == null ? candidateDisplayExpression != null
			: !EEFMultipleReferencesDescriptionImpl.CANDIDATE_DISPLAY_EXPRESSION_EDEFAULT.equals(candidateDisplayExpression);
		case EefPackage.EEF_MULTIPLE_REFERENCES_DESCRIPTION__ON_CLICK_EXPRESSION:
