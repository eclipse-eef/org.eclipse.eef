...
public interface EefPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link org.eclipse.eef.impl.EEFCustomDescriptionImpl <em>EEF Custom Description</em>}
	 * ' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @see org.eclipse.eef.impl.EEFCustomDescriptionImpl
	 * @see org.eclipse.eef.impl.EefPackageImpl#getEEFCustomDescription()
	 * @generated
	 */
	int EEF_CUSTOM_DESCRIPTION = 13;
	 ...
	 * @ordered
	 */
	int EEF_CUSTOM_DESCRIPTION__IDENTIFIER = EefPackage.EEF_WIDGET_DESCRIPTION__IDENTIFIER;
	 ...
	 * @ordered
	 */
	int EEF_CUSTOM_DESCRIPTION__LABEL_EXPRESSION = EefPackage.EEF_WIDGET_DESCRIPTION__LABEL_EXPRESSION;
	 ...
	 * @ordered
	 */
	int EEF_CUSTOM_DESCRIPTION__CUSTOM_EXPRESSIONS = EefPackage.EEF_WIDGET_DESCRIPTION_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>EEF Custom Description</em>' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 *
	 * @generated
	 * @ordered
	 */
	int EEF_CUSTOM_DESCRIPTION_FEATURE_COUNT = EefPackage.EEF_WIDGET_DESCRIPTION_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.eef.EEFCustomDescription <em>EEF Custom Description</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return the meta object for class '<em>EEF Custom Description</em>'.
	 * @see org.eclipse.eef.EEFCustomDescription
	 * @generated
	 */
	EClass getEEFCustomDescription();

	/**
	 * Returns the meta object for the containment reference list '
	 * {@link org.eclipse.eef.EEFCustomDescription#getCustomExpressions <em>Custom Expressions</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @return the meta object for the containment reference list '<em>Custom Expressions</em>'.
	 * @see org.eclipse.eef.EEFCustomDescription#getCustomExpressions()
	 * @see #getEEFCustomDescription()
	 * @generated
	 */
	EReference getEEFCustomDescription_CustomExpressions();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link org.eclipse.eef.impl.EEFCustomDescriptionImpl
		 * <em>EEF Custom Description</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 *
		 * @see org.eclipse.eef.impl.EEFCustomDescriptionImpl
		 * @see org.eclipse.eef.impl.EefPackageImpl#getEEFCustomDescription()
		 * @generated
		 */
		EClass EEF_CUSTOM_DESCRIPTION = EefPackage.eINSTANCE.getEEFCustomDescription();
		 ...
		 * @generated
		 */
		EReference EEF_CUSTOM_DESCRIPTION__CUSTOM_EXPRESSIONS = EefPackage.eINSTANCE.getEEFCustomDescription_CustomExpressions();
