...
public class EefExtWidgetsReferenceAdapterFactory extends AdapterFactoryImpl {
	...
	protected EefExtWidgetsReferenceSwitch<Adapter> modelSwitch = new EefExtWidgetsReferenceSwitch<Adapter>() {
		...
		@Override
		public Adapter caseEEFExtReferenceWidgetStyle(EEFExtReferenceWidgetStyle object) {
			return createEEFExtReferenceWidgetStyleAdapter();
		}

		@Override
		public Adapter caseEEFExtReferenceConditionalStyle(EEFExtReferenceConditionalStyle object) {
			return createEEFExtReferenceConditionalStyleAdapter();
		}
