...
public class MarkupWidgetsPackageImpl extends EPackageImpl implements MarkupWidgetsPackage {
	 ...
	 * @generated
	 */
	public static final String copyright = " Copyright (c) Obeo, Eclipse contributors and others 2023.\n This program and the accompanying materials\n are made available under the terms of the Eclipse Public License 2.0\n which accompanies this distribution, and is available at\n https://www.eclipse.org/legal/epl-2.0/\n\n SPDX-License-Identifier: EPL-2.0\n\n Contributors:\n    Obeo and Israel Aerospace Industries - initial API and implementation\n"; //$NON-NLS-1$
	...
	public void initializePackageContents() {
		...
		initEClass(eefExtHTMLRendererDescriptionEClass, EEFExtHTMLRendererDescription.class, "EEFExtHTMLRendererDescription", !IS_ABSTRACT, //$NON-NLS-1$
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEEFExtHTMLRendererDescription_ToHtmlExpression(), theEcorePackage.getEString(), "toHtmlExpression", null, 1, 1, //$NON-NLS-1$
				EEFExtHTMLRendererDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEEFExtHTMLRendererDescription_ValueExpression(), theEcorePackage.getEString(), "valueExpression", null, 1, 1, //$NON-NLS-1$
				EEFExtHTMLRendererDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEEFExtHTMLRendererDescription_NumberOfLine(), theEcorePackage.getEInt(), "numberOfLine", "5", 1, 1, //$NON-NLS-1$//$NON-NLS-2$
				EEFExtHTMLRendererDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEEFExtHTMLRendererDescription_EditExpression(), theEcorePackage.getEString(), "editExpression", null, 0, 1, //$NON-NLS-1$
				EEFExtHTMLRendererDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEEFExtHTMLRendererDescription_EditionToolExpression(), theEcorePackage.getEString(), "editionToolExpression", null, 0, 1, //$NON-NLS-1$
				EEFExtHTMLRendererDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEEFExtHTMLRendererDescription_CssExpression(), theEcorePackage.getEString(), "cssExpression", null, 0, 1, //$NON-NLS-1$
				EEFExtHTMLRendererDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(eefExtMarkdownWidgetEClass, EEFExtMarkdownWidget.class, "EEFExtMarkdownWidget", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEEFExtMarkdownWidget_ValueExpression(), theEcorePackage.getEString(), "valueExpression", null, 1, 1, //$NON-NLS-1$
				EEFExtMarkdownWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEEFExtMarkdownWidget_NumberOfLine(), theEcorePackage.getEInt(), "numberOfLine", "5", 1, 1, EEFExtMarkdownWidget.class, //$NON-NLS-1$//$NON-NLS-2$
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEEFExtMarkdownWidget_EditExpression(), theEcorePackage.getEString(), "editExpression", null, 0, 1, //$NON-NLS-1$
				EEFExtMarkdownWidget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
