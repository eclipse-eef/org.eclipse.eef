...
public class EEFTab {
	...
	public void refresh() {
		...
		String title = new Eval(eefView.getInterpreter(), eefView.getVariableManager()).get(labelExpression, String.class);
		...
		Object object = new Eval(eefView.getInterpreter(), eefView.getVariableManager()).get(imageExpression, Object.class);
