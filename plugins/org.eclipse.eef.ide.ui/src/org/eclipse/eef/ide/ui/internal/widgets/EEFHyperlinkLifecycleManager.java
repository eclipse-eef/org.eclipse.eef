...
public class EEFHyperlinkLifecycleManager extends AbstractEEFWidgetLifecycleManager {
	...
	protected void createMainControl(Composite parent, IEEFFormContainer formContainer) {
		...
		this.hyperlink = new StyledText(parent, SWT.READ_ONLY);
		this.hyperlink.setEditable(false);
		this.hyperlink.setEnabled(true);
		widgetFactory.paintBordersFor(parent);

		this.hyperlink.setLayoutData(formData);
	...
	protected void setHyperlinkStyle(EEFHyperlinkStyle style) {
		if (style != null) {
			...
			setForegroundColor(style.getForegroundColorExpression(), EefPackage.Literals.EEF_HYPERLINK_STYLE__FOREGROUND_COLOR_EXPRESSION, hyperlink);
		}
