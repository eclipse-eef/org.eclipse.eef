...
public class EEFDateLifecycleManager extends AbstractEEFWidgetLifecycleManager {
	...
	/**
	 * Get the DateTime style according to the user display value.
	 *
	 * @return the DateTime style according to the user display value.
	 */
	...
	/**
	 * Get the java date from the widget date.
	 *
	 * @return the java date from the widget date.
	 */
	private Date getDate() {
		Calendar calendar = Calendar.getInstance();
		calendar.set(Calendar.MILLISECOND, this.ms);
		calendar.set(Calendar.ZONE_OFFSET, this.zoneOffset);
		calendar.set(Calendar.ZONE_OFFSET, this.dstOffset);
	...
	/**
	 * Set the widget date from a java date.
	 *
	 * @param newDate
	 *            the new java date to apply.
	 */
	private void setDate(Date newDate) {
		if (newDate != null) {
			...
			this.zoneOffset = calendar.get(Calendar.ZONE_OFFSET);
			this.dstOffset = calendar.get(Calendar.DST_OFFSET);
