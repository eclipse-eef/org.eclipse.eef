 ...
 *******************************************************************************/
package org.eclipse.eef.ide.ui.internal.extension.impl;
 ...
 */
public class EEFCustomWidgetDescriptionProviderRegistryEventListener<T> extends AbstractRegistryEventListener {
	...
	/** Provider tag of extension point. */
	 ...
	 */
	public EEFCustomWidgetDescriptionProviderRegistryEventListener(String namespace, String extensionPointID, IItemRegistry<T> itemRegistry) {
	...
	protected boolean validateConfigurationElement(IConfigurationElement configurationElement) {
		...
		if (TAG_PROVIDER.equals(configurationElement.getName())) {
