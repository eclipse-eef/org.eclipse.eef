...
public class EEFGroupLifecycleManager extends AbstractEEFLifecycleManager {
	...
	public void createControl(Composite parent, IEEFFormContainer formContainer) {
		...
		EvalFactory.of(this.interpreter, this.variableManager).logIfInvalidType(String.class)
		.call(labelExpression, (value) -> this.section.setText(Objects.firstNonNull(value, ""))); //$NON-NLS-1$
	...
	public void aboutToBeShown() {
		...
		this.lifecycleManagers.forEach((lifecycleManager) -> lifecycleManager.aboutToBeShown());
	}
	...
	public void refresh() {
		...
		this.lifecycleManagers.forEach((lifecycleManager) -> lifecycleManager.refresh());
	}
	...
	public void aboutToBeHidden() {
		...
		this.lifecycleManagers.forEach((lifecycleManager) -> lifecycleManager.aboutToBeHidden());
	}
	...
	@Override
	public void dispose() {
		this.lifecycleManagers.forEach((lifecycleManager) -> lifecycleManager.dispose());
	}
