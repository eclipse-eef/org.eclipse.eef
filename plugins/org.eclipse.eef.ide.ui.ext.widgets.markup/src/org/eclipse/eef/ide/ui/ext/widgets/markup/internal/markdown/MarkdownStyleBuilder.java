...
public class MarkdownStyleBuilder {
	 ...
	 */
	private static final Comparator<StyleRange> STYLE_CMP = Comparator.comparingInt((StyleRange sr) -> sr.start)
			.thenComparingInt((StyleRange sr) -> sr.length);
	 ...
	 * Provider of style.
	 */
	private MarkdownStyleFactory styleProvider;
	 ...
	 */
	public MarkdownStyleBuilder(MarkdownStyleFactory styleProvider) {
