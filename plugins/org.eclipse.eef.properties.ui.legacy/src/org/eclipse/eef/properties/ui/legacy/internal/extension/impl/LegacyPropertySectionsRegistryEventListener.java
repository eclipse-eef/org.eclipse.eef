		...
		if (TAG_PROPERTY_SECTIONS.equals(configurationElement.getName())) {
			...
			for (IConfigurationElement propertySection : propertySections) {
				...
				try {
					...
					LegacyPropertySectionItemDescriptor legacySectionDescriptor = new LegacyPropertySectionItemDescriptor(tab, filter, sectionClass,
							id, enablesFor, afterSection, inputTypes, eefTypeMapper);
