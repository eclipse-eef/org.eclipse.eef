...
public class LegacyPropertyContributorRegistryEventListener extends AbstractRegistryEventListener {
	...
	protected boolean processAddition(IConfigurationElement configurationElement) {
		if (TAG_PROPERTY_CONTRIBUTOR.equals(configurationElement.getName())) {
			...
			LegacyPropertyContributorItemDescriptor propertyContributor = new LegacyPropertyContributorItemDescriptor(contributorId, labelProvider,
					actionProvider, typeMapper, sectionDescriptorProvider, tabDescriptorProvider, overridableTabListContentProvider, categories);
