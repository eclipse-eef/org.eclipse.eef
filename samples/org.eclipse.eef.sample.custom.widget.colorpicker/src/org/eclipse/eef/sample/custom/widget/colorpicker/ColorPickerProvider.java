...
public class ColorPickerProvider implements IEEFLifecycleManagerProvider {
    ...
    @Override
    public ILifecycleManager getLifecycleManager(EEFCustomWidgetDescription customWidgetDescription, IVariableManager variableManager, IInterpreter interpreter, ModelChangeExecutor mce) {
        return new ColorPickerLifecycleManager(customWidgetDescription, variableManager, interpreter, mce);
    }
}
