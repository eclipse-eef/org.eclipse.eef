...
public class ColorPickerLifecycleManager extends AbstractEEFWidgetLifecycleManager {
     ...
     */
    public ColorPickerLifecycleManager(EEFCustomWidgetDescription description, IVariableManager variableManager, IInterpreter interpreter, EditionContextAdapter eca) {
        super(variableManager, interpreter, eca);
    ...
    protected void createMainControl(Composite parent, IEEFFormContainer formContainer) {
        ...
        this.controller = new ColorPickerController(this.description, this.variableManager, this.interpreter, this.eca);
    }
