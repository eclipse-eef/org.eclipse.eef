...
public class ColorPickerLifecycleManager extends AbstractEEFWidgetLifecycleManager {
     ...
     */
    public ColorPickerLifecycleManager(EEFCustomWidgetDescription description, IVariableManager variableManager, IInterpreter interpreter, EditionContextAdapter contextAdapter) {
