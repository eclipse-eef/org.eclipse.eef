...
public class EEFExtEObjectSelectionWizard extends Wizard {
	 ...
	 *            The editing context adapter
	 */
	public EEFExtEObjectSelectionWizard(EObject currentEObject, EReference eReference, EditingContextAdapter editingContextAdapter) {
	...
	public void addPages() {
		...
		this.eObjectSelectionPage = new EEFExtEObjectSelectionPage(this.currentEObject, this.eReference, this.editingContextAdapter);
