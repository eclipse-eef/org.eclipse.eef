...
public abstract class AbstractEEFExtReferenceLifecycleManager extends AbstractEEFWidgetLifecycleManager {
	 ...
	 */
	protected EObject semanticCandidate;
	 ...
	 *            The context adapter
	 */
	public AbstractEEFExtReferenceLifecycleManager(EEFExtReferenceDescription description, EObject semanticCandidate, EReference eReference,
	...
	public void refresh() {
		...
		if (Util.isBlank(this.description.getLabelExpression())) {
			Adapter adapter = this.composedAdapterFactory.adapt(this.semanticCandidate, IItemPropertySource.class);
