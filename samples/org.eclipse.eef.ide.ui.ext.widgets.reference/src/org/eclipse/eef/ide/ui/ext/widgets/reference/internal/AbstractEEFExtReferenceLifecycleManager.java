...
public abstract class AbstractEEFExtReferenceLifecycleManager extends AbstractEEFWidgetLifecycleManager {
	 ...
	 *            The context adapter
	 */
	public AbstractEEFExtReferenceLifecycleManager(EEFExtReferenceDescription description, EReference eReference, IVariableManager variableManager,
	...
	/**
	 * Returns the variable with the name self if it is an EObject.
	 *
	 * @return The variable with the name self if it is an EObject, <code>null</code> otherwise
	 */
	protected EObject getSelf() {
	...
	private void initializeRemoveButton() {
		...
		this.removeButton.setToolTipText(Messages.ReferenceRemoveButton_tooltipText);
	}
	...
	public void refresh() {
		...
		if (Util.isBlank(this.description.getLabelExpression())) {
			...
			Adapter adapter = this.composedAdapterFactory.adapt(self, IItemPropertySource.class);
