...
public class EEFExtEObjectCreationPage extends WizardPage {
	 ...
	 *            The editing context adapter
	 */
	public EEFExtEObjectCreationPage(EObject currentEObject, EReference eReference, EditingContextAdapter editingContextAdapter) {
	...
	public void createControl(Composite parent) {
		...
		if (this.eReference.isContainment()) {
			...
			this.initializeContainmentInput(this.currentEObject, this.eReference);
		} else {
	...
	private void performFinishMultiValuedContainmentReference(EObject value) {
		this.eContainmentAdd(this.currentEObject, this.eReference, value);
	}
	...
	private void performFinistMonoValuedContainmentReference(EObject value) {
		this.currentEObject.eSet(this.eReference, value);
	}
