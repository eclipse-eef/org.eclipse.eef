...
public class EEFExtSingleReferenceLifecycleManager extends AbstractEEFExtReferenceLifecycleManager {
	 ...
	 *            The context adapter
	 */
	public EEFExtSingleReferenceLifecycleManager(EEFExtReferenceDescription description, EReference eReference, IVariableManager variableManager,
	...
	protected void browseButtonCallback() {
		...
		IWizard wizard = new EEFExtEObjectSelectionWizard(self, this.eReference, this.contextAdapter);
	...
	protected void removeButtonCallback() {
		this.getSelf().eUnset(this.eReference);
	}
	...
	public void refresh() {
		...
		EObject self = this.getSelf();
		Object value = self.eGet(this.eReference);
