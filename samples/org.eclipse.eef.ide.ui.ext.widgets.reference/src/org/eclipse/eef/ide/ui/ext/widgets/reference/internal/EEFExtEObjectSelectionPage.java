...
public class EEFExtEObjectSelectionPage extends WizardPage {
	 ...
	 *            The editing context adapter
	 */
	public EEFExtEObjectSelectionPage(EObject currentEObject, EReference eReference, EditingContextAdapter editingContextAdapter) {
	...
	public void performFinish(IProgressMonitor monitor) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (object instanceof EObject) {
				EObject eObject = (EObject) object;
				if (this.eReference.getEReferenceType().isInstance(eObject)) {
					this.currentEObject.eSet(this.eReference, eObject);
				}
			}
		}
	}
