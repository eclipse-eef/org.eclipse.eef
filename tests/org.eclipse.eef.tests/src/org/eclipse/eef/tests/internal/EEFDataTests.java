...
public class EEFDataTests {
	...
	/**
	 * Test model used to compute the label of a date widget.
	 */
	public static final String EEFDATECONTROLLERTESTS_LABEL = "/data/controllers/date/EEFDateControllerTests-Label.xmi"; //$NON-NLS-1$

	/**
	 * Test model used to compute the help of a date widget.
	 */
	public static final String EEFDATECONTROLLERTESTS_HELP = "/data/controllers/date/EEFDateControllerTests-Help.xmi"; //$NON-NLS-1$

	/**
	 * Test model used to compute the value of a date widget.
	 */
	public static final String EEFDATECONTROLLERTESTS_VALUE = "/data/controllers/date/EEFDateControllerTests-Value.xmi"; //$NON-NLS-1$
	...
	private static final String[] MODELS = new String[] { EEFTEXTCONTROLLERTESTS_LABEL, EEFTEXTCONTROLLERTESTS_VALUE, EEFTEXTCONTROLLERTESTS_HELP,
			...
			EEFSELECTCONTROLLERTESTS_HELP, EEFSELECTCONTROLLERTESTS_LABEL, EEFSELECTCONTROLLERTESTS_VALUE, EEFDATECONTROLLERTESTS_HELP,
			EEFDATECONTROLLERTESTS_LABEL, EEFDATECONTROLLERTESTS_VALUE };
