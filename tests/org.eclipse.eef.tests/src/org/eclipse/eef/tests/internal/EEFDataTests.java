...
public class EEFDataTests {
	...
	/**
	 * Test model used to compute the label of a file picker widget.
	 */
	public static final String EEFFILEPICKERCONTROLLERTESTS_LABEL = "/data/controllers/filepicker/EEFFilePickerControllerTests-Label.xmi"; //$NON-NLS-1$

	/**
	 * Test model used to compute the help of a file picker widget.
	 */
	public static final String EEFFILEPICKERCONTROLLERTESTS_HELP = "/data/controllers/filepicker/EEFFilePickerControllerTests-Help.xmi"; //$NON-NLS-1$

	/**
	 * Test model used to compute the path of a file picker widget.
	 */
	public static final String EEFFILEPICKERCONTROLLERTESTS_PATH = "/data/controllers/filepicker/EEFFilePickerControllerTests-Path.xmi"; //$NON-NLS-1$
