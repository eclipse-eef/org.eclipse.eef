...
public class EEFDataTests {
	...
	/**
	 * Test model used to compute the label of an image viewer widget.
	 */
	public static final String EEFIMAGEVIEWERONTROLLERTESTS_LABEL = "/data/controllers/imageviewer/EEFImageViewerControllerTests-Label.xmi"; //$NON-NLS-1$

	/**
	 * Test model used to compute the help of an image viewer widget.
	 */
	public static final String EEFIMAGEVIEWERCONTROLLERTESTS_HELP = "/data/controllers/imageviewer/EEFImageViewerControllerTests-Help.xmi"; //$NON-NLS-1$

	/**
	 * Test model used to compute the path of an image viewer widget.
	 */
	public static final String EEFIMAGEVIEWERONTROLLERTESTS_PATH = "/data/controllers/imageviewer/EEFImageViewerControllerTests-Path.xmi"; //$NON-NLS-1$
	...
	private static final String[] MODELS = new String[] { EEFTEXTCONTROLLERTESTS_LABEL, EEFTEXTCONTROLLERTESTS_VALUE, EEFTEXTCONTROLLERTESTS_HELP,
			...
			EEFSELECTCONTROLLERTESTS_HELP, EEFSELECTCONTROLLERTESTS_LABEL, EEFSELECTCONTROLLERTESTS_VALUE, EEFIMAGEVIEWERCONTROLLERTESTS_HELP,
			EEFIMAGEVIEWERONTROLLERTESTS_LABEL, EEFIMAGEVIEWERONTROLLERTESTS_PATH, };
