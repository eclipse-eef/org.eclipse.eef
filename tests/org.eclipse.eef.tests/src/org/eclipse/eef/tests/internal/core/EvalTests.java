...
/**
 * Tests of the {@link Eval} utility class.
 *
 * @author sbegaudeau
 */
...
public class EvalTests {
	...
	public void testGetResult() {
		...
		Object result = Eval.of(interpreter, variableManager).get(FIRST_EXPRESSION);
	...
	public void testGetDefaultValue() {
		...
		assertThat(Eval.of(interpreter, variableManager).get(FIRST_EXPRESSION), nullValue());

		Object result = Eval.of(interpreter, variableManager).defaultValue(FIRST_RESULT).get(FIRST_EXPRESSION);
		assertThat(result, is(FIRST_RESULT));
	}
	...
	public void testGetCastValue() {
		...
		String stringResult = Eval.of(interpreter, variableManager).logIfInvalidType(String.class).get(FIRST_EXPRESSION);
		assertThat(stringResult, is(FIRST_RESULT));

		Boolean booleanResult = Eval.of(interpreter, variableManager).logIfInvalidType(Boolean.class).get(SECOND_EXPRESSION);
