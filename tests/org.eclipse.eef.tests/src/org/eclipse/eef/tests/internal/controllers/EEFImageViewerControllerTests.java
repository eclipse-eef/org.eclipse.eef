...
public class EEFImageViewerControllerTests extends AbstractEEFControllerTests {
	...
	private IEEFImageViewerController textController(String modelPath) {
	...
	public void testLabel() {
		testLabel(textController(EEFDataTests.EEFIMAGEVIEWERONTROLLERTESTS_LABEL), "Project:"); //$NON-NLS-1$
	}

	@Test
	public void testHelp() {
		testHelp(textController(EEFDataTests.EEFIMAGEVIEWERCONTROLLERTESTS_HELP), "Project Help"); //$NON-NLS-1$
	}

	@Test
	public void testValue() {
		AtomicBoolean atomicBoolean = new AtomicBoolean(false);
		IEEFImageViewerController controller = this.textController(EEFDataTests.EEFIMAGEVIEWERONTROLLERTESTS_PATH);
